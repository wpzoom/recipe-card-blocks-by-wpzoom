...
class Recipe_Card extends Widget_Base {
	...
	protected function register_style_controls() {
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Styles', 'wpzoom-recipe-card' ),
