...
class Recipe_Card extends Widget_Base {
	...
	public function __construct( $data = [], $args = null ) {
		...
		wp_register_script( 'wpzoom-rcb-script-js', WPZOOM_RCB_PLUGIN_URL . 'dist/assets/js/script.js', [ 'jquery' ], WPZOOM_RCB_VERSION, true );
	...
	public function get_title() {
		return esc_html__( 'Recipe Card', 'wpzoom-recipe-card' );
	}
	...
	public function get_categories() {
		return [ 'wpzoom-elementor-recipe-card' ];
	}
	...
	protected function register_content_controls() {
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Recipe Card', 'wpzoom-recipe-card' ),
		...
		$this->add_control(
			'title',
			[
				'label'   => esc_html__( 'Card Title', 'wpzoom-recipe-card' ),
				'type'    => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
				'label_block' => true,
				'placeholder' => esc_html__( 'Card Title', 'wpzoom-recipe-card' ),
			]
		);
		$this->add_control(
			'recipe_card_summary',
			[
				'label' => esc_html__( 'Card Summary', 'wpzoom-recipe-card'),
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Card SEO', 'wpzoom-recipe-card' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			)
		);
