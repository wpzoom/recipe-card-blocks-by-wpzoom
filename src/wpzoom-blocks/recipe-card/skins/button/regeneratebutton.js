...
const RegenerateButton = ( props ) => {
    ...
    return ( <div className="ai-div">
        <Button className="regenerate-recipe-button" onClick={ () => {
            ...
            <span className="btn-text">{ props.type === 'nutrition' ?
                ( ! prompts.recipe ?
                    __( 'Calculate nutrition with AI', 'recipe-card-blocks-by-wpzoom' ) :
                    __( 'Recalculate nutrition with AI', 'recipe-card-blocks-by-wpzoom' ) ) :
                ( props.type === 'image' ?
                    __( 'Regenerate image with 1 AI credit', 'recipe-card-blocks-by-wpzoom' ) :
                    __( 'Regenerate recipe with 1 AI credit', 'recipe-card-blocks-by-wpzoom' ) ) }</span>
        </Button>
        { /* Loader */ }
			...
			<Popover className="popup-overlay" position="center center">
				<div className="popup-content popup-content-error">
					...
					<div className="Content-suggestions">
                        ...
                        <p>{ __( 'Please connect your Recipe Card Blocks account', 'recipe-card-blocks-by-wpzoom' ) }</p>
                        <a className="components-button is-primary" href={`${siteURL}/wp-admin/admin.php?page=admin-license`}>{ __( 'AI Credits and Connect page', 'recipe-card-blocks-by-wpzoom' ) }</a>
					</div>
				</div>
			</Popover>
		) }
        ...
        { showToast && ( <CustomToast
            message={ success ? __( 'Recipe Regenerated Successfully', 'recipe-card-blocks-by-wpzoom' ) : error ? error : __( 'Insufficient credits', 'recipe-card-blocks-by-wpzoom' ) }
