                                                ...
                                                <div class="wpz-grid-wrap">
                                                    ...
                                                    <div class="section">
                                                        ...
                                                        <p class="about">
                                                            ...
                                                            <?php esc_html_e( 'Show a confirmation pop-up when readers rate your recipes and collect written reviews together with the rating. You can even require a comment for low ratings — so negative votes always come with actionable feedback.', 'recipe-card-blocks-by-wpzoom' ); ?>
                                                        </p>
                                    ...
                                    <div class="theme-comparison">
                                                    ...
                                                    <table class="plugin-comparison-table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="table-index"><h3><strong><?php esc_html_e( 'Rating Modal & Written Reviews', 'recipe-card-blocks-by-wpzoom' ); ?></strong></h3></td>
                            ...
                            <div class="wpz-onboard_content-side">
                                ...
                                <div class="wpz-onboard_content-side-section discover-premium">
                                    ...
                                    <ul>
                                        ...
                                        <li><span class="dashicons dashicons-yes"></span> <?php esc_html_e( 'Rating Modal & Written Reviews', 'recipe-card-blocks-by-wpzoom' ); ?></li>
