...
class WPZOOM_Settings {
	...
	/**
	 * Check if user (on-card) star ratings are enabled.
	 *
	 * @since 3.5.0
	 * @return boolean
	 */
                        ...
                        'fields'   => array(
                            array(
                                ...
                                'args'  => array(
                                    ...
                                    'class'       => 'wpzoom-rcb-field',
                                    'description' => esc_html__( 'Allow visitors to vote your recipes by clicking the stars on the recipe card.', 'recipe-card-blocks-by-wpzoom' ),
                                    'default'     => true,
                                    'preview'     => true,
                                    'preview_pos' => 'top',
                                ),
                            ...
                            array(
                                ...
                                'title' => __( 'User Ratings Mode', 'recipe-card-blocks-by-wpzoom' ),
                                'type'  => 'select',
                                'args'  => array(
                                    'label_for'   => 'wpzoom_rcb_settings_user_ratings_mode',
                                    'class'       => 'wpzoom-rcb-field',
                                    'description' => esc_html__( 'Choose what happens when a visitor clicks the stars on the recipe card. The confirmation modal with comments is available in the PRO version.', 'recipe-card-blocks-by-wpzoom' ),
                                    'default'     => 'instant',
                                    'options'     => array(
                                        'instant'          => __( 'Instant rating (no confirmation)', 'recipe-card-blocks-by-wpzoom' ),
                                        'jump_to_comments' => __( 'Jump to the comments section when clicking stars', 'recipe-card-blocks-by-wpzoom' ),
                                    ),
                                ),
                            ),
                            ...
                            array(
                                ...
                                'args'  => array(
                                    ...
                                    'class'       => 'wpzoom-rcb-field',
                                    'description' => esc_html__( 'Allow visitors to vote recipes when adding a comment. Ratings are added to your recipe metadata and enable stars in Google search results.', 'recipe-card-blocks-by-wpzoom' ),
                                    'default'     => true,
                                    'preview'     => true,
                                    'preview_pos' => 'top',
                                ),
                ...
                <div class="wpz_right-col">
                   ...
                   <div class="wpz-rcb_onboard_wrapper">
                               ...
                               <div class="wpz-onboard_content-side">
                                   ...
                                   <div class="wpz-onboard_content-side-section discover-premium">
                                       ...
                                       <ul>
                                           ...
                                           <li><span class="dashicons dashicons-yes"></span> <?php esc_html_e( 'Rating Modal & Reviews', 'recipe-card-blocks-by-wpzoom' ); ?></li>
                    ...
                    <div class="license-wrap">
                        ...
                        <ul class="wpzoom-rcb-social-links">
                            <li>
                                <a href="https://facebook.com/recipeblock" target="_blank" rel="noopener">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                                    <span><?php esc_html_e( 'Facebook', 'recipe-card-blocks-by-wpzoom' ); ?></span>
                                </a>
                            </li>
                            <li>
                                <a href="https://www.facebook.com/groups/recipeblock" target="_blank" rel="noopener">
                                    ...
                                    <span><?php esc_html_e( 'Facebook Group for Food Bloggers', 'recipe-card-blocks-by-wpzoom' ); ?></span>
                                </a>
                            </li>
                            <li>
                                <a href="https://twitter.com/recipeblock" target="_blank" rel="noopener">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                                    <span><?php esc_html_e( 'X (Twitter)', 'recipe-card-blocks-by-wpzoom' ); ?></span>
                                </a>
                            </li>
                            <li>
                                <a href="https://instagram.com/recipecardblocks/" target="_blank" rel="noopener">
                                    ...
                                    <span><?php esc_html_e( 'Instagram', 'recipe-card-blocks-by-wpzoom' ); ?></span>
                                </a>
                            </li>
                        </ul>
                        <style>
                            .wpzoom-rcb-social-links {
                                list-style: none;
                                margin: 0;
                                padding: 0;
                            }
                            .wpzoom-rcb-social-links li {
                                margin: 0 0 4px;
                            }
                            .wpzoom-rcb-social-links a {
                                display: inline-flex;
                                align-items: center;
                                gap: 10px;
                                padding: 8px 0;
                            ...
                            .wpzoom-rcb-social-links a:hover {
                                color: #E1581A;
                            }
                            .wpzoom-rcb-social-links svg {
                                flex-shrink: 0;
                                opacity: .9;
                            }
                            .wpzoom-rcb-social-links a:hover svg {
                                opacity: 1;
                            }
                        </style>
                    </div>
