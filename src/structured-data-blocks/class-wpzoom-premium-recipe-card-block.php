...
class WPZOOM_Premium_Recipe_Card_Block {
	...
	public function register_hooks() {
		...
		register_block_type( 'wpzoom-recipe-card/block-premium-recipe-card', array(
	...
	/**
	 * Returns the JSON-LD for a ingredient's name in a premium-recipe-card block.
	 *
	 * @param array $ingredient The attributes of a ingredient in the premium-recipe-card block.
	 *
	 * @return array The JSON-LD representation of the ingredient name in a premium-recipe-card block.
	 */
	...
	/**
	 * Returns the JSON-LD for a step's description in a premium-recipe-card block.
	 *
	 * @param array $step The attributes of a step(-section) in the premium-recipe-card block.
	 *
	 * @return array The JSON-LD representation of the step's description in a premium-recipe-card block.
	 */
