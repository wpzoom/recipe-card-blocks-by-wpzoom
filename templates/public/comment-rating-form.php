<?php
/**
 * Template to be used for the comment rating form.
 *
 * @since       3.5.0
 *
...
$comment_rating_svg_empty = class_exists( 'WPZOOM_Comment_Rating' ) ? WPZOOM_Comment_Rating::get_rating_star_svg( 'empty' ) : '';
$comment_rating_svg_full  = class_exists( 'WPZOOM_Comment_Rating' ) ? WPZOOM_Comment_Rating::get_rating_star_svg( 'full' ) : '';
